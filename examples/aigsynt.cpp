...
//    mtbddnode_t n = MTBDD_GETNODE(game.gates[gate]);
//    size_t used, total;
//    sylvan_table_usage(&used, &total);
    mtbdd_ref(game.gates[gate]);
//    INFO("sylvan_and(%llu, %llu) = (idx: %llu n.a: %llu, n.b: %llu) (%zu)\n", l, r, game.gates[gate], n->a, n->b, used);
}
...
//        sylvan_re_hook_progre(TASK(reordering_progress));
    ...
    if (1) sylvan_stats_report(stdout);
