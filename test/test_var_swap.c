...
UTEST_TASK_0(variable_swap_test, var_swap)  {
    ...
    // swap the variables
    ASSERT_EQ(sylvan_varswap(level_six), SYLVAN_VAR_SWAP_SUCCESS);
...
UTEST_TASK_0(variable_swap_test, var_swap_hash)  {
    ...
    ASSERT_EQ(sylvan_varswap(6), SYLVAN_VAR_SWAP_SUCCESS);
...
UTEST_TASK_0(variable_swap_test, var_swap_random_swap)  {
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        ASSERT_EQ(sylvan_varswap(6), SYLVAN_VAR_SWAP_SUCCESS);
        ASSERT_EQ(sylvan_varswap(7), SYLVAN_VAR_SWAP_SUCCESS);
        ASSERT_EQ(sylvan_varswap(6), SYLVAN_VAR_SWAP_SUCCESS);
